...
{
    // custom dependency property for image source
    public static readonly DependencyProperty ImageSourceProperty = DependencyProperty.Register("ImageSource", typeof(ImageSource), typeof(HeaderImageControl), null);
